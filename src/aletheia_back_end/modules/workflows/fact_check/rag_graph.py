...
def get_rag_workflow_app() -> Any:
    components_config = load_workflow_core_components_config(settings.fact_check_workflow_config_path)
    nodes_config = load_nodes_config(settings.fact_check_workflow_config_path)
