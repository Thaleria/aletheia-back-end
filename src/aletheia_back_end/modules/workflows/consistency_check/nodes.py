...
nodes_config = load_workflow_nodes_config(workflow_name="consistency_check", path="src/aletheia_back_end/config/rag_workflow_config.yml")
consistency_check_prompt = nodes_config["generate_node"]["prompt"]
